...
- Blockers: GPU server for faster inference; IBKR stream/order need local IB Gateway/TWS restart (Gateway listening but API not responding/zombie state observed 2026-04-25)
